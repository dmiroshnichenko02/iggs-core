...
<section class="pb-[90px]">
    <div style="background-image:url('<?= esc_url($background) ?>');background-size:cover;background-position:center;">
        <div class="container mx-auto">
            <div class="h-[700px] flex items-end pb-[60px]">
                <h2 class="text-h2 uppercase leading-h2 font-light font-archivo text-white max-w-[678px] mb-[20px]"><?= esc_html($title) ?></h2>
            </div>
        </div>
    </div>
    <div class="container mx-auto">
        <div class="flex justify-between items-cemter gap-[60px] mt-[90px] mb-[80px]">
            <div class="form-custom w-full">
                <?php echo do_shortcode($form_shortcode); ?>
            </div>
            <div class="min-w-[384px] w-[384px] h-fit bg-dark-blue py-[39px] px-[32px] pb-[100px]" style="background-image:url('<?= esc_url($contact_group['background']) ?>');background-position:bottom right; background-repeat: no-repeat;">
